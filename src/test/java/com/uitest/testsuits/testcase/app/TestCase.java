package com.uitest.testsuits.testcase.app;
...
import com.uitest.core.ElementManager;
import com.uitest.log.LogManager;
import com.uitest.org.AppUtil;
...
public class TestCase {
	...
	public void testCase_webview_000() {
		// startTestCase();
		// 点击拨号
		ElementManager.clickById(driver,"tab_call");

		// 点击云服务
		ElementManager.clickById(driver,"tab_cloud");

		// 点击更多
		ElementManager.clickById(driver,"iab_ib_more");

		// 点击登录
		ElementManager.clickById(driver,"setting_item_login");

		// 点击互联网登录
		ElementManager.clickById(driver,"btn_login_dynamic");

		// 点击注册
		ElementManager.clickById(driver,"setting_new_login_btn_register");

		// 清空并填写手机号码
		intoContentEditTextById("setting_register_phone_et", loginPwd);

		// 点击短信验证码
		ElementManager.clickById(driver,"setting_register_get_ver_btn");

		sleepTime(5000);

		LogManager.reportLog("RegisteredPhone", "使用已注册的号码，在注册页面进行注册");
	}
...
//		sleepTime(2000);
//
//		Myassert("没有发送成功", isExistenceById("iab_sub_title") && getTextViewNameById("iab_sub_title").equals(phone));
//
//		back("tab_mms");
//
//		reportLog("短信对聊页,转发（选择分组联系人）");
