...
public class ElementManager {
	 ...
	 * @return
	 */
	public static WebElement getFirstTextView(AndroidDriver driver,String name, int index) {
		System.out.println("[start] getFirstTextView");
		for (WebElement el : getElementsByClassAndIndex(driver,
	 ...
	 * @return
	 */
	public static List<WebElement> getElementsByClassAndIndex(AndroidDriver driver,String classname,
			int index) {
	...
	public static void clickLongByNameUseJs(AndroidDriver<WebElement> driver,
		...
		// 这里容易出问题，查找控件经常出错
		WebElement element = getFirstTextView(driver, TextViewName, 1);
		if (element == null) {
