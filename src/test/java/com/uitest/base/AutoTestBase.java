...
import com.uitest.base.operateFactory.AndroidOperate;
import com.uitest.base.operateFactory.AppOperate;
import com.uitest.base.operateFactory.IosOperate;
import com.uitest.base.operateFactory.WebOperate;
import com.uitest.util.HandleSafetyTips;
import com.uitest.util.Log;
import com.uitest.util.StartAppiumServer;
import com.uitest.util.StaticConfig;
import com.uitest.util.Tools;
...
public class AutoTestBase {
	...
	public void afterMethod() {
		if (platformName.toLowerCase().contains("android")
				|| platformName.toLowerCase().contains("ios")) {
			operateBase.backToHomePage(null);
		}
	}
